...
void DDA(){
	...
	glBegin(GL_POINTS);
		...
		cout <<"INGRESE LA ESQUINA INFERIOR IZQUIERDA X1 DEL RECTANGULO ==>"; cin >> x_1;
		cout <<"INGRESE LA ESQUINA INFERIOR IZQUIERDA Y1 DEL RECTANGULO ==>"; cin >> y_1;
		cout <<"INGRESE LA ESQUINA SUPERIOR DERECHA X2 DEL RECTANGULO ==> "; cin >> x_2;
		cout <<"INGRESE LA ESQUINA SUPERIOR DERECHA Y2 DEL RECTANGULO ==>"; cin >> y_2;
...
void Bresenham(){
	...
	glBegin(GL_POINTS);
		...
		cout <<"INGRESE LA ESQUINA INFERIOR IZQUIERDA X1 DEL RECTANGULO ==>"; cin >> x_1;
		cout <<"INGRESE LA ESQUINA INFERIOR IZQUIERDA Y1 DEL RECTANGULO ==>"; cin >> y_1;
		cout <<"INGRESE LA ESQUINA SUPERIOR DERECHA X2 DEL RECTANDULO ==> "; cin >> x_2;
		cout <<"INGRESE LA ESQUINA SUPERIOR DERECHA Y2 DEL RECTANGULO ==>"; cin >> y_2;
...
int main(int argc, char *argv[]){
	cout <<"INGRESE CON QUE METODO DESEA DIBUJAR EL RECTANGULO \n ===>DDA=1 \n ===>BRESENHAM=2 \n"; cin>> figura;
	if (figura==1){
